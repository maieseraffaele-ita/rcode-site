...
export class TranslationService {
  ...
  private translations: Translations = {
    it: {
      ...
      'contact.form_gdpr': 'Ho letto e accetto la Privacy Policy',
    ...
    en: {
      ...
      'contact.form_gdpr': 'I have read and accept the Privacy Policy',
    ...
    de: {
      ...
      'contact.form_gdpr': 'Ich habe die Datenschutzrichtlinie gelesen und akzeptiert',
